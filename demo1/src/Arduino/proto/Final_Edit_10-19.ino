...
//  Depreceate
//    cumError_Dif = cumError_Dif + error_Dif * elapsedTime;
//
//    if (abs(current_angle_L) > abs(current_angle_R))
//    {
//      right_act_signal = right_act_signal + (error_Dif * Kp_Dif);  
//   
//      else
//      {
//        right_act_signal = right_act_signal - (error_Dif * Kp_Dif);
...
//    {
//      if (left_act_signal > 0){
//        left_act_signal = left_act_signal + (error_Dif * Kp_Dif);  
//      }
//      else{
//        left_act_signal = left_act_signal - (error_Dif * Kp_Dif);
//        }
...
//  phiOld = phiNew;
  ...
  pid(left_wheel_theta, -81.3, right_wheel_theta, 81.3, timeNow/1000000);
